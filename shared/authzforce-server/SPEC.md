...
|---|:---:|---|
| `<externalId>` | Yes | External identifier; must be unique per experiment to avoid cross-domain grant leakage |
...
domain's grant set. Optional provider and action suffixes, which enable
