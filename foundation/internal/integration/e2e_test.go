...
import (
	...
	srapi "arrowhead/foundation/internal/api"
	blclient "arrowhead/foundation/internal/blacklist/client"
	srrepo "arrowhead/foundation/internal/repository"
	srsvc "arrowhead/foundation/internal/service"

	authapi "arrowhead/foundation/internal/authentication/api"
	authrepo "arrowhead/foundation/internal/authentication/repository"
	authsvc "arrowhead/foundation/internal/authentication/service"

	caapi "arrowhead/foundation/internal/consumerauth/api"
	carepo "arrowhead/foundation/internal/consumerauth/repository"
	casvc "arrowhead/foundation/internal/consumerauth/service"

	dynapi "arrowhead/foundation/internal/orchestration/dynamic/api"
	dynsvc "arrowhead/foundation/internal/orchestration/dynamic/service"

	ssapi "arrowhead/foundation/internal/orchestration/simplestore/api"
	ssrepo "arrowhead/foundation/internal/orchestration/simplestore/repository"
	sssvc "arrowhead/foundation/internal/orchestration/simplestore/service"

	fsapi "arrowhead/foundation/internal/orchestration/flexiblestore/api"
	fsrepo "arrowhead/foundation/internal/orchestration/flexiblestore/repository"
	fssvc "arrowhead/foundation/internal/orchestration/flexiblestore/service"
)
