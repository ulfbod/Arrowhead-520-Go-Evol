...
to the canonical shape below. Any deviation that is not explicitly documented
is a defect.

This document is enforced mechanically by
...
*Created: 2026-05-29. Enforced by core/internal/arch/arch_test.go.*
