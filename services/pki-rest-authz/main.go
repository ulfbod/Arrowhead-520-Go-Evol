...
//
//	CA_URL             profile-ca plain HTTP URL (default: http://profile-ca:8787)
//	CA_TLS_URL         profile-ca mTLS URL (default: https://profile-ca:8788)
//	AUTHZFORCE_URL     AuthzForce base URL (default: http://authzforce:8080/authzforce-ce)
//	AUTHZFORCE_DOMAIN  AuthzForce domain externalId (default: arrowhead-520)
//	PIP_URL            PIP base URL (default: http://profile-ca:8787)
...
//	PORT               Plain HTTP port (default: 9209)
//	TLS_PORT           mTLS HTTPS port (default: 9208)
...
func main() {
	caURL       := envOr("CA_URL", "http://profile-ca:8787")
	caTLSURL    := envOr("CA_TLS_URL", "https://profile-ca:8788")
	azURL       := envOr("AUTHZFORCE_URL", "http://authzforce:8080/authzforce-ce")
	azDomainExt := envOr("AUTHZFORCE_DOMAIN", "arrowhead-520")
	pipURL       := envOr("PIP_URL", "http://profile-ca:8787")
	upstreamURL := os.Getenv("UPSTREAM_URL")
	port        := envOr("PORT", "9209")
	tlsPort     := envOr("TLS_PORT", "9208")
